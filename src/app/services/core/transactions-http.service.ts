...
import {CreateTransactionDto, UpdateTransactionDto, TransactionModel} from '@models/core';
...
export class TransactionsHttpService {
  API_URL = `${environment.API_URL}/core/transactions`;

  constructor(private httpClient: HttpClient, private messageService: MessageService) {
  }

  create(payload: CreateTransactionDto): Observable<TransactionModel> {
  ...
  update(id: string, payload: UpdateTransactionDto): Observable<TransactionModel> {
    const url = `${this.API_URL}/${id}`;
  ...
  enable(id: string): Observable<TransactionModel> {
  ...
  disable(id: string): Observable<TransactionModel> {
  ...
  findCatalogues(): Observable<TransactionModel[]> {
