...
export class InstitutionalStrategicPlansHttpService {
  ...
  create(payload: CreateInstitutionalStrategicPlanDto): Observable<InstitutionalStrategicPlanModel> {
  ...
  findOne(id: string): Observable<InstitutionalStrategicPlanModel> {
  ...
  update(id: string, payload: UpdateInstitutionalStrategicPlanDto): Observable<InstitutionalStrategicPlanModel> {
    const url = `${this.API_URL}/${id}`;
  ...
  remove(id: string): Observable<InstitutionalStrategicPlanModel> {
    const url = `${this.API_URL}/${id}`;
