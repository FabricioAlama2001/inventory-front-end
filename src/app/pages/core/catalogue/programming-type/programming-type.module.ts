...
import { ProgrammingTypeRoutingModule } from './programming-type-routing.module';
...
@NgModule({
  declarations: [
    ProgrammingTypeFormComponent,
    ProgrammingTypeListComponent,
  ],
  imports: [
    NgCommonModule,
    ProgrammingTypeRoutingModule,
    ReactiveFormsModule,
    SharedModule,
    ButtonModule,
    CalendarModule,
